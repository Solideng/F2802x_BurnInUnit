//----------------------------------------------------------------------------------
//
// FILE:	LED-ColorMix-DevInit_F2802x.c
//
// DESCRIPTION:	Device initialization for F2802x (PiccoloA) series
// 
//----------------------------------------------------------------------------------
...
//--------------------------------------------------------------------------------------
//  GPIO-03 - PIN FUNCTION = LOAD_3 PWM2b
...
//--------------------------------------------------------------------------------------
//  GPIO-04 - PIN FUNCTION = DC_STAGE PWM3A
...
//--------------------------------------------------------------------------------------
//  GPIO-05 - PIN FUNCTION = AC_STAGE PWM3B
...
//  GPIO-32 - PIN FUNCTION = I2C-SDA
	...
	GpioCtrlRegs.GPBPUD.bit.GPIO32 = 0;    	// Pull-up disable disabled
...
//  GPIO-33 - PIN FUNCTION = I2C-SCL
	...
	GpioCtrlRegs.GPBPUD.bit.GPIO33 = 0;    	// Pull-up disable disabled
