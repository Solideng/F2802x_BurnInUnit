...
// TODO:...
// MODE DOES NOT NEED TO BE DETECTED AFTER STARTUP - NO NEED FOR INTERRUPT - MAY MEAN SPI INIT CAN BE SEPERTED OUT.
// IF UNIT IS MASTER, SHOULD CHECK FOR EXISTANCE OF SLAVE AT STARTUP.
// IF UNIT IS SLAVE, SHOULD BE READY TO RESPOND FOR MASTER CHECKING FOR ITS EXISTANCE AT STARTUP.

// IF SLAVE AC VSNS ADC OUTPUT SHOULD BYPASS AC VCTRL IIR AND CONNECT DIRECTLY TO AC ICTRL IIR REF INPUT
//  ALSO, THE AC OVP CHECK IS REDUNDANT AND SHOULD BE DISABLED.
// WHAT SHOULD BE DONE WITH GPIO12, AC PHASE OUT ?? Disabling it *for now*
