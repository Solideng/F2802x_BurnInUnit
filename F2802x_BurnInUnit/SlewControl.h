 ...
 * @param[in]	trgt	Specifies the value of the slew target to be applied (amps).
 * @return				Error status.
 */
 ...
 * @param[in]	load	Specifies the load the setting is to be applied to.
 * @param[in]	stp		Specifies the value of the slew step size to be applied (amps).
 * @return				Error status.
 */
 ...
 * @param[out]	trgtDest	Address of the memory location at which to place the query result (amps).
 * @return					Error status.
 */
 ...
 * @param[in]	load	Specifies the load the setting is to be read from.
 * @param[out]	stpDest	Address of the memory location at which to place the query result (amps).
 * @return				Error status.
 */
