...
struct Commros
{
	...
	unsigned char (*UserFunctions)(const unsigned char* const input,unsigned char* const output,const unsigned char packetsize, const unsigned char szOutbuf);
...
//
// Bitmap of Enabled/Disabled Functions (start/stop/reset/enableInterrupts/disableinterrupts)
//
